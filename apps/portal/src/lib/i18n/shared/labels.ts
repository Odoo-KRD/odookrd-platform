...
const ku: SharedLabels = {
  ...
  course: "کۆرس",
  courseCompleted: "کۆرس تەواوکراوە",
  courses: "کۆرسەکان",
  created: "دروستکراوە",
  dashboard: "داشبۆرد",
  ...
  markAllRead: "هەمووی وەک خوێندراوە",
  markRead: "وەک خوێندراوە دیاری بکە",
  no: "نەخێر",
...
export const sharedLabels: Record<Locale, SharedLabels> = { ku, ar, en };
