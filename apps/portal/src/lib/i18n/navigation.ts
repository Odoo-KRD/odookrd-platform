...
const ku = {
  ...
  helpdesk: "ناوەندی پشتگیری",
  helpdeskQueue: "ڕیزی پشتگیری",
  helpdeskDepartments: "بەشەکان",
  knowledge: "بنکەی زانیاری",
  knowledgeCategories: "پۆلەکان",
  knowledgeArticles: "بابەتەکان",
  notifications: "ئاگادارکردنەوەکان",
  deliveryLog: sharedText.ku.labels.deliveryLog,
  notificationsInbox: "ناوسندوقی بەڕێوەبەر",
...
const ar = {
  ...
  helpdesk: "مركز الدعم",
  helpdeskQueue: "قائمة الدعم",
  helpdeskDepartments: "الأقسام",
  knowledge: "قاعدة المعرفة",
  knowledgeCategories: "الفئات",
  knowledgeArticles: "المقالات",
  notifications: "الإشعارات",
  deliveryLog: sharedText.ar.labels.deliveryLog,
  notificationsInbox: "صندوق المسؤول",
