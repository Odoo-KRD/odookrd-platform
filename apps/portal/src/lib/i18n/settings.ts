import type { Locale, SettingCategory, SettingSource } from "@odookrd/types";
...
export const settingsDictionaries: Record<Locale, SettingsDictionary> = {
  ku: {
    ...
    sources: { DEFAULT: "بنەڕەت", PLATFORM: "پلاتفۆرم", COMPANY: "کۆمپانیا" },
    localeOptions: { ku: "کوردی", ar: "عەرەبی", en: "ئینگلیزی" },
    booleanOptions: { enabled: "چالاک", disabled: "ناچالاک" },
    fields: {
      "general.site_title": {
        label: "ناوی ماڵپەڕ",
  ...
  ar: {
    ...
    sources: { DEFAULT: "افتراضي", PLATFORM: "المنصة", COMPANY: "الشركة" },
    localeOptions: { ku: "الكردية", ar: "العربية", en: "الإنجليزية" },
    booleanOptions: { enabled: "مفعّل", disabled: "معطّل" },
    fields: {
      "general.site_title": {
        label: "عنوان الموقع",
  ...
  en: {
    ...
    sources: { DEFAULT: "Default", PLATFORM: "Platform", COMPANY: "Company" },
    localeOptions: { ku: "Kurdish", ar: "Arabic", en: "English" },
    booleanOptions: { enabled: "Enabled", disabled: "Disabled" },
    fields: {
      "general.site_title": {
        label: "Site title",
