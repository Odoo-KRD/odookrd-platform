    ...
    >
      ...
      <div className="shrink-0 border-t border-line p-3">
        <button
          ...
          className={`flex min-h-10 w-full min-w-0 items-center gap-3 overflow-hidden rounded-md px-3 py-2 text-sm font-medium text-muted transition-colors hover:bg-surface-subtle hover:text-content ${
